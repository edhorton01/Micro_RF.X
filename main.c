...
const uint16_t Led_B8P3[] = {
    ...
    0x0036, 0x001C, 0x0003,
    0x0036, 0x001E, 0x0004,
    0x0036, 0x001f, 0x0005,
    0x0082, 0x001f, 0x0005,
    0x0082, 0x001f, 0x0005,
    0x0082, 0x001f, 0x0005,
    0x0082, 0x001f, 0x0005,
    0x0081, 0x0000, 0x0002, 0x0081, 0x0000, 0x0002
...
const uint16_t Led_B9P1[] = {
    0x003c, 0x07FF, 0x000B, 0x0081, 0x0000, 0x0000,
    0x003c, 0x07FF, 0x000B, 0x0081, 0x0000, 0x0000,
    0x003c, 0x07FF, 0x000B, 0x0081, 0x0000, 0x0000,
    0x0081, 0x0000, 0x0000, 0x0081, 0x0000, 0x0000, 0x0081, 0x0000, 0x0000, 0x0081, 0x0000, 0x0000, 0x0081, 0x0000, 0x0000,
    0x00A2, 0x07FF, 0x000B, 0x0081, 0x0000, 0x0000,
    0x00A2, 0x07FF, 0x000B, 0x0081, 0x0000, 0x0000,
    0x00A2, 0x07FF, 0x000B, 0x0081, 0x0000, 0x0000,
    0x0081, 0x0000, 0x0000, 0x0081, 0x0000, 0x0000, 0x0081, 0x0000, 0x0000, 0x0081, 0x0000, 0x0000, 0x0081, 0x0000, 0x0000,
    0x003c, 0x07FF, 0x000B, 0x0081, 0x0000, 0x0000,
...
void main(void)
{
    ...
    while (1)
    {
        ...
        else
        {
            ...
            if (KeyStatus._pressed || Key._DB_cnt || Charge || TurnOff || WL_hold || BOOT_hold || BRT_hold || BACK_hold || FRONT_hold)
            {
                OSCCONbits.IDLEN = 1;
            }
            else
